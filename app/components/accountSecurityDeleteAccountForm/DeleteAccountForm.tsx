...
export default function DeleteAccountForm() {
    return (
        <form className={styles.deleteAccountForm} method="post" asp-controller="Account" asp-action="DeleteAccount">
            ...
            <p>When you delete your account, your public profile will be deactivated immediately. If you change your mind before the 14 days are up, sign in with your email and password, and well send you a link to reactive your account</p>
